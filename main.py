...
# Credit to BBXO Corporation by LxxHB
# Github: https://github.com/LxxHB
...
class Console():        
    def ui(self):
        os.system(f'cls && title [BBXO] Discord Nitro Generator  ^|  Follow LxxHB on github' if os.name == "nt" else "clear")
        print(center(f"""\n\n

██████╗ ██████╗ ██╗ ██╗ █████╗
██╔══██╗██╔══██╗╚██╗██╔╝██╔══██╗           ~ BXXO Discord Nitro Generator ~
██████╦╝██████╦╝ ╚███╔╝ ██║  ██║
██╔══██╗██╔══██╗ ██╔██╗ ██║  ██║          github.com/LxxHB ~ BBXO Corporation
██████╦╝██████╦╝██╔╝╚██╗╚█████╔╝
╚═════╝ ╚═════╝ ╚═╝  ╚═╝ ╚════╝\n\n
